...
def main():
    ...
    if(args[1] == '1'):
        input_file = 'D:/mutational_signature/MS_cLDA/result/data' + args[1] + '_o' + args[3] \
            + '_all_1/result_k' + topic + '.txt'
    else:
        input_file = 'D:/mutational_signature/MS_cLDA/result/data' + args[1] + '_o' + args[3] \
            + '_all_1/figure/' + args[2] + '/k' + topic + '.txt'
    ...
    matching_file = "D:/mutational_signature/MS_cLDA/result/data" + args[1] + '_o' + args[3] + '_all_1' \
    ...
    while(i < K*2-1):
        ...
        j += 1
    matching.close()
    df_file = "D:/mutational_signature/MS_cLDA/result/data" + args[1] + '_o' + args[3] + '_all_1' \
    ...
    for i in range(K):
        ...
        dataframe.write(str(i+1) + ' (mutation)' + ' in all' + ',')
        for j in range(96):
    ...
    for i in range(0, K*2, 2):
        ...
        fig.tight_layout()
        name = 'D:/mutational_signature/MS_cLDA/result/data' + args[1] + '_o' + args[3] + '_all_1' \
